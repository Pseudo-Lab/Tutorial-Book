...
# [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/1jjFiq5pZyytlmouN6B1_Y8g39fXKyfMB#scrollTo=iIEvXM16HsVt)
...
# 
# CNN 모델은 1D, 2D, 3D로 나뉘는데, 일반적인 CNN은 보통 이미지 분류에 사용되는 2D를 통칭합니다. 여기서 D는 차원을 뜻하는 dimentional의 약자로, 인풋 데이터 형태에 따라 1D, 2D, 3D 형태의 CNN 모델이 사용됩니다.
# 
# <br>
# 
# ![그림 5-1](https://github.com/Pseudo-Lab/Tutorial-Book/blob/master/pics/TS-ch5img01.png?raw=true)
# 
# 
...
# ### 5.2.2 1D CNN 테스트
# 
# ![그림 5-2](https://github.com/Pseudo-Lab/Tutorial-Book/blob/master/pics/TS-ch5img02.png?raw=true)
# ![그림 5-3](https://github.com/Pseudo-Lab/Tutorial-Book/blob/master/pics/TS-ch5img03.png?raw=true)
# 
...
# 5개의 입력 예시들이 `kernel_size`가 2인 1D CNN을 통과하니 4개의 값이 산출됐습니다. 해당 값들이 어떻게 산출 됐는지 알아보게습니다. 우선 `c`에 저장된 weight와 bias 값을 확인해보겠습니다.
